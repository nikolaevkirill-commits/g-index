...
lineage = [
    {
        ...
        "component": "Expert K penalty = 2-Kp; dashboard raw geomagnetic term Kp-2",
        "weight_or_threshold": "Expert: linear 2-Kp. Dashboard: reported separately and thresholded by engine rules",
    ...
    },
    {
        ...
        "normalization": "G_raw = Kp-2 + Li + Mi + ei + Pi + Di + Sn_pen, with provenance",
