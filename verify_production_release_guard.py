...
def main() -> None:
    ...
    require(index, 'decisionScore:hasEngine?operationalScore:undefined', 'fail-closed operational score export')
    require(index, "actionPolicy = !decisionAvailable ? 'reference_unavailable'", 'no-engine action policy')
