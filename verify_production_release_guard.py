...
def main() -> None:
    ...
    require(index, 'const decisionAvailable = hasEngine && !referenceStale;', 'stale reference cannot authorize action')
    require(index, "referenceStale ? 'reference_stale' : 'reference_unavailable'", 'missing/stale reference action policy')
